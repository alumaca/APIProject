...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post commands_url, params: { command: { code: @command.code, command_name: @command.command_name } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { code: @command.code, command_name: @command.command_name } }
