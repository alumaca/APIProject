...
+ I DB delle applicazioni son in in [SQLLite3](https://www.sqlite.org/index.html). Su S.O. Windows è consigliato scaricare il DBML
...
1. Installare Ruby scaricare file RubyInstaller per Windows ed è stata utilizzata la versione 3.0.0
...
4. Creare il Database ed effettuare la migrazione  con i comand
> rails db:crearte
> rails db:migrate
...
7. Creare il Database ed effettuare la migrazione  con i comand
> rails db:crearte
> rails db:migrate
